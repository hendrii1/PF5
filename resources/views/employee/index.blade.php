            ...
            <table class="table table-bordered table-hover table-striped mb-0 bg-white">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('employees.show', ['employee' => 1]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi bi-eye-fill"></i></a>
                                <a href="{{ route('employees.edit', ['employee' => 1]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi bi-pencil-fill"></i></a>
