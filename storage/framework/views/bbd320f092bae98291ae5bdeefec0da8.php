...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            <a href="<?php echo e(route('home')); ?>" class="navbar-brand mb-0 h1"><i class="bi bi-hexagon-fill me-2"></i> Data Master</a>
            ...
            <table class="table table-bordered table-hover table-striped mb-0 bg-white">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="<?php echo e(route('employees.show', ['employee' => 1])); ?>" class="btn btn-outline-dark btn-sm me-2"><i class="bi bi-eye-fill"></i></a>
                                <a href="<?php echo e(route('employees.edit', ['employee' => 1])); ?>" class="btn btn-outline-dark btn-sm me-2"><i class="bi bi-pencil-fill"></i></a>
...
<?php /**PATH C:\xampp\htdocs\Laravel\modul4\resources\views/employee/index.blade.php ENDPATH**/ ?>